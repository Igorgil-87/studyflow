...
def fake_quiz_tool(**kw):
    calls["n"] += 1
    p = os.path.join(tempfile.gettempdir(), f"quiz_{calls['n']}.json")
...
p1 = llm_cache.smart_call("openai","quiz","gpt-4o-mini", fake_quiz_tool,
        cache_key=key, result_kind="file", file_dir=tempfile.gettempdir(),
...
p3 = llm_cache.smart_call("openai","quiz","gpt-4o-mini", fake_quiz_tool,
        cache_key=key_sim, result_kind="file", file_dir=tempfile.gettempdir(),
...
p4 = llm_cache.smart_call("openai","quiz","gpt-4o-mini", fake_quiz_tool,
        ...
        file_dir=tempfile.gettempdir(), trace_id="job4", input_text="t", topic="samurais")
